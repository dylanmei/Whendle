...
describe 'Time'
	...
	describe 'getting time since'
		it 'should get now'
			a = Time.now()
			b = Time.now()
			a.since(b).should.have_property 'minutes', 0
			a.since(b).should.have_property 'hours', 0
			a.since(b).should.have_property 'days', 0
		end

		it 'should get minutes'
			a = Time.now()
			b = Time.now().subtract(Time.minutes, 5)
			a.since(b).should.have_property 'minutes', 5
			a.since(b).should.have_property 'hours', 0
			a.since(b).should.have_property 'days', 0
		end
		it 'should get hours'
			a = Time.now()
			b = Time.now().subtract(Time.hours, 5)
			a.since(b).should.have_property 'minutes', 5 * 60
			a.since(b).should.have_property 'hours', 5
			a.since(b).should.have_property 'days', 0
		end

		it 'should get days'
			a = Time.now()
			b = Time.now().subtract(Time.days, 5)
			a.since(b).should.have_property 'minutes', 5 * 60 * 24
			a.since(b).should.have_property 'hours', 5 * 24
			a.since(b).should.have_property 'days', 5
		end
	end
end